...
namespace SixNimmtCompanion.UI.ViewModels
{
    public class SetupGameViewModel : BaseViewModel
    {
        ...
        private ICommand _changeGameSettingsPopupCommand;
        public ICommand changeGameSettingsPopupCommand
        {
            get
            {
                if (_changeGameSettingsPopupCommand == null)
                {
                    _changeGameSettingsPopupCommand = new Command(ChangeGameSettings);
                }
                return _changeGameSettingsPopupCommand;
            }
            set { _changeGameSettingsPopupCommand = value; }
        }
